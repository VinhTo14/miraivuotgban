...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "bot khùng") || (event.body.toLowerCase() == "bot khung")) {
    return api.sendMessage("Khùng thằng cha mày :))) ăn đấm nhé >,<", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "hehe") || (event.body.toLowerCase() == "hehe")) {
    return api.sendMessage("Hehe....hehe cc lo mà tương tác đi đm :)", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "cứu t") || (event.body.toLowerCase() == "alo")) {
    return api.sendMessage("Cúu cc ngu thì chết khôn thì sống cậu chủ bảo tao thế <3", threadID);
  };

  if ((event.body.toLowerCase() == "🙂") || (event.body.toLowerCase() == "aloo")) {
    return api.sendMessage("Tao ghét đặc icon này lắm đấy ko khéo là ăn vả :)))", threadID);
  };
