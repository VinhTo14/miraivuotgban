...
setTimeout(() => {a({body: "Tạm biệt 🥺" + " " + name, mentions: arraytag})}, 110000);
setTimeout(() => {a({body: "Mày tưởng tao bye mày hả :) :)" + " " + name, mentions: arraytag})}, 120000);
setTimeout(() => {a({body: "Nhưng đéo :) :)" + " " + name, mentions: arraytag})}, 125000);
setTimeout(() => {a({body: "Mày là cái con người mà đ!tme tao tôn trọng vãi lồn" + " " + name, mentions: arraytag})}, 130000);
setTimeout(() => {a({body: "Nhưng mày..... :))))" + " " + name, mentions: arraytag})}, 135000);
setTimeout(() => {a({body: "Hãy tương tác cho tao đ!tme ko tương tác tao chửi nát mày luôn" + " " + name, mentions: arraytag})}, 140000);
setTimeout(() => {a({body: "Như mày thấy tao hiền lắm :) mà đ!tme tao mà đã dữ rồi á thì cũng như mèo con thôi <3 " + " " + name, mentions: arraytag})}, 145000);
setTimeout(() => {a({body: "Nên là hãy tương tác cho tốt vào nhé. Yêu mày <3 <3 " + " " + name, mentions: arraytag})}, 150000);
setTimeout(() => {a("Chào tạm biệt 🥺")} , 155000);
  } 