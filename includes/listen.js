module.exports = function({ api, models }) {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "This bot was made by JRT" : global.config.BOTNAME}`, "[ BOT INFO ]");
...
//THIZ BOT WAS MADE BY JRT - DO NOT REUP (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧